...
public class TestConsumer4China {
  ...
  public static void main(String[] args) throws IOException, TimeoutException {
    ...
    // 接受 China 信息
    channel.queueBind(queueName, EXCHANGE_NAME, S2_CHINA);
    System.out.println(name + " 等待接受消息");
    // DefaultConsumer类实现了Consumer接口，通过传入一个频道，告诉服务器我们需要哪个频道的消息，如果频道中有消息，就会执行回调函数handleDelivery
    Consumer consumer =
